...
from tf_keras.engine.input_layer import InputLayer as KerasInputLayer
from tf_keras.preprocessing import image


class FixedInputLayer(KerasInputLayer):
...
class FixedBatchNorm(keras.layers.BatchNormalization):
    def __init__(self, **kwargs):
