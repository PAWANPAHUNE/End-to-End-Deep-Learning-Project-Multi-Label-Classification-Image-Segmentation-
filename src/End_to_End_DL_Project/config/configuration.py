...
from End_to_End_DL_Project.entity.config_entity import DataIngestionConfig, PrepareBaseModelConfig, TrainingConfig, EvaluationConfig
import os
...
class ConfigurationManager:
    ...
    def get_prepare_base_model_config(self) -> PrepareBaseModelConfig:
        ...
        prepare_base_model_config = PrepareBaseModelConfig(
            ...
            params_unfreeze_deep=self.params.UNFREEZE_DEEP_BLOCKS # Reading from params.yaml
        )
